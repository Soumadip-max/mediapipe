            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="rounded-2xl bg-slate-900/80 border border-slate-800 p-6 space-y-4">
                    ...
                    <div className="h-40 rounded-xl bg-slate-950 border border-slate-800 p-4 text-xs text-slate-500 font-mono overflow-hidden relative">
                        ...
                        <div className="absolute inset-0 bg-gradient-to-b from-transparent via-slate-950/60 to-slate-950 flex items-center justify-center">
                            <button className="px-5 py-2.5 rounded-full bg-[#c4f82a] text-[#07090e] font-bold text-xs shadow-lg shadow-[#c4f82a]/20 hover:scale-105 transition-all">
                ...
                <div className="rounded-2xl bg-slate-900/80 border border-slate-800 p-6 space-y-4">
                    <div className="flex items-center justify-between">
                        ...
                        <span className="px-2.5 py-1 rounded-full bg-[#c4f82a]/20 text-[#c4f82a] text-xs font-bold font-mono border border-[#c4f82a]/30">
                            84% ATS Score
                        </span>
                    </div>
